...
@section('content')
    ...
    <form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow dark:bg-slate-800" action="{{route('posts.storeS')}}" method="POST">
        ...
        <label for="">
            Cheque<br><input name="cheque" type="text" value="{{old('cheque')}}">
            @error('cheque')
                <br>
                <small style="color : red ">{{$message}}</small>
            @enderror
        ...
        <label for="">
            C/P<br><input name="cp" type="text" value="{{old('cp')}}">
            @error('cp')
                <br>
                <small style="color : red ">{{$message}}</small>
            @enderror
        ...
        <label for="">
            Salida <br><input name="salida" type="float" value="{{old('salida')}}">
            @error('salida')
                <br>
                <small style="color : red ">{{$message}}</small>
            @enderror
